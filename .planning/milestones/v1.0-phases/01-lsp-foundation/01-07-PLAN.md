...
must_haves:
  ...
  artifacts:
    - path: "documentation/tutorial/04-document-sync.md"
      provides: "Document Sync implementation tutorial in Korean"
      contains: "didOpen"
      min_lines: 100
    - path: "documentation/tutorial/05-diagnostics.md"
...
<task type="auto">
  ...
  <files>documentation/tutorial/04-document-sync.md</files>
  <action>
...
Target length: 150-200 lines.
  ...
  <verify>
File exists at `documentation/tutorial/04-document-sync.md` with all 7 sections, Korean text, and at least 100 lines
  </verify>
  <done>
...
<task type="auto">
  ...
  <files>documentation/tutorial/05-diagnostics.md</files>
  <action>
...
Target length: 180-250 lines.
  ...
  <verify>
File exists at `documentation/tutorial/05-diagnostics.md` with all 8 sections, Korean text, and at least 100 lines
  </verify>
  <done>
...
<verification>
1. `documentation/tutorial/04-document-sync.md` exists with all sections
2. `documentation/tutorial/05-diagnostics.md` exists with all sections
