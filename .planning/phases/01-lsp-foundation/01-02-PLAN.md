...
must_haves:
  ...
  artifacts:
    - path: "docs/tutorial/01-lsp-concepts.md"
      provides: "LSP fundamentals tutorial in Korean"
      contains: "JSON-RPC"
      min_lines: 100
    - path: "docs/tutorial/02-library-choice.md"
...
<task type="auto">
  ...
  <files>docs/tutorial/01-lsp-concepts.md</files>
  <action>
Create `docs/tutorial/` directory if it doesn't exist.
...
Target length: 150-200 lines of well-formatted Markdown.
  ...
  <verify>
File exists at `docs/tutorial/01-lsp-concepts.md` with all 6 sections, Korean text, and at least 100 lines
  </verify>
  <done>
...
<task type="auto">
  ...
  <files>docs/tutorial/02-library-choice.md</files>
  <action>
...
Target length: 80-120 lines.
  ...
  <verify>
File exists at `docs/tutorial/02-library-choice.md` with comparison table, Korean text, and at least 50 lines
  </verify>
  <done>
...
<verification>
1. `docs/tutorial/01-lsp-concepts.md` exists with 6 sections in Korean
2. `docs/tutorial/02-library-choice.md` exists with comparison table
