...
must_haves:
  ...
  artifacts:
    - path: "docs/tutorial/03-project-setup.md"
...
<task type="auto">
  ...
  <files>docs/tutorial/03-project-setup.md</files>
  <action>
...
Target length: 120-180 lines.
  ...
  <verify>
File exists at `docs/tutorial/03-project-setup.md` with all 8 sections, Korean text, bash commands, and at least 80 lines
  </verify>
  <done>
...
<verification>
1. `docs/tutorial/03-project-setup.md` exists with all sections
